...
import CustomerQna from './components/views/CustomerQnA/CustomerQna';
import QnaList from './components/views/CustomerQnA/QnaList';
import QnaListPage from './components/views/CustomerQnA/QnaListPage';
    ...
    <Router>
      <div>
        ...
        <Switch>
          ...
          <Route exact path="/write" component={Auth(CustomerQna, true)} />
          <Route exact path="/qnalist/:requireId" component={Auth(QnaList, true)} />
          <Route exact path="/qnalist/" component={Auth(QnaListPage, true)} />
